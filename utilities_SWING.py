...
def detect_peaks_hybrid_interactive(proc,
    ...
    """
    from ipywidgets import IntSlider, FloatSlider, Checkbox, Output, VBox, Label
    ...
    def update_plot(nb_peaks, qmin, qmax, fit_window_width, subtract_power_law):
    ...
    update_plot(nb_peaks_init, qmin_init, qmax_init, fit_window_width_init, subtract_power_law_init)
